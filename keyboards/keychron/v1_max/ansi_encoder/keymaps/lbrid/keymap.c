...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [MAC_BASE] = LAYOUT_ansi_82(
    ...
    [WIN_BASE] = LAYOUT_ansi_82(
        ...
        KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     TD(TD_EN_DASH),KC_EQL,KC_BSPC,          KC_PGUP,
        KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_PGDN,
...
void leader_end_user(void) {
    // Leader + S = print email signature - Default ("Kind Regards")
    if (leader_sequence_one_key(KC_S)) {
        SEND_STRING("Kind regards\nLouis\n");
    }
    // Leader + S + T = print email signature - "Thanks"
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    //             // Windows keypad codes for en-dash
